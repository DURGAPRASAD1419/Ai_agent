...
def process_user_query(user_input, pdf_file_path=None):
    ...
    try:
        ...
        if any(keyword in user_input.lower() for keyword in ['help', 'what can you do', 'how to use', 'instructions']):
            return """
Research Paper Agent - MERN Stack Generator

I can help you:
1. Extract content from research paper PDFs
2. Analyze the content to identify key concepts and features
3. Generate complete MERN stack applications based on the analysis
4. Create downloadable ZIP files with the complete project

To use me:
- Upload a PDF research paper
- I'll analyze it and generate a MERN stack project
- You'll get a complete, ready-to-run application

Just upload your PDF and I'll do the rest!
"""
        
        # Check if user wants to process a PDF
        if pdf_file_path and os.path.exists(pdf_file_path):
            return process_pdf_file(pdf_file_path)
        elif 'pdf' in user_input.lower() or 'upload' in user_input.lower():
            return """
Please provide the path to your PDF file, or upload it through the interface.
I'll then analyze it and generate a complete MERN stack application for you.
"""
        else:
            return """
Hello! I'm your Research Paper Agent. I can analyze research papers and generate MERN stack applications.

To get started:
1. Upload a research paper PDF
2. I'll extract and analyze the content
3. Generate a complete MERN stack project
4. Provide you with a downloadable ZIP file
...
root_agent = Agent(
    ...
    instruction='''You are a research paper analysis agent. When a user interacts with you:

1. If they ask for help or instructions, provide clear guidance on how to use you
2. If they upload a PDF research paper, extract the content and analyze it
3. Generate a complete MERN stack project structure based on the analysis
4. Create all necessary code files for both frontend and backend
5. Create a downloadable ZIP file with the complete project
6. Provide the local directory path where the ZIP file can be downloaded

Always be helpful, clear, and provide structured responses. 

When a user asks for help, respond with:
"Research Paper Agent - MERN Stack Generator
...
When a user mentions PDF or upload, respond with:
"Please provide the path to your PDF file, or upload it through the interface.
I'll then analyze it and generate a complete MERN stack application for you."
''',
)
